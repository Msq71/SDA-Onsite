...
public class C02JunitAnnotations {
    ...
    * *****ANNOTATIONS******
    ...
    WebDriver driver;   // Declare WebDriver in class scope , So we can use it with different tests
    ...
    public void test1(){
        ...
        System.out.println("Test1 annotation is executed...");
    }

    @Test
    public void test2(){
        driver.get("https://www.Google.com");
        System.out.println("Test2 annotation is executed...");
    }
}
